...
<body>
    ...
    <div class="mypage">
        ...
        <div class="grade">
            ...
            <div><p>저희 쇼핑몰을 이용해 주셔서 감사합니다. <strong>${loginMap.MEM_NAME }</strong>님은 <strong>[${loginMap.CK }]</strong> 이십니다.</p></div>
        </div>
        <div class="userInfo">
            <div class="title">
                <h3>기본정보</h3>
            ...
            <form id="updateFrm" onsubmit="return validateAndSubmitForm()">
                <table class="table1">
                    <tr>
                        <th>아이디</th>
                        <td><input type="text" name="mem_id" id="mem_id" value="${member.mem_id }" readonly="readonly"></td>
                    </tr>
                    <tr>
                        <th>이메일</th>
                        <td><input type="email" name="email" id="email" value="${member.email }" readonly="readonly"></td>
                    </tr>
                    <tr>
                        <th>비밀번호</th>
                        <td><input type="password" name="mem_pw" id="mem_pw" value="${member.mem_pw }" ></td>                   
                    </tr>
                    <tr>
                        <th>비밀번호 확인</th>
                        <td><input type="password" name="mem_pw2" id="mem_pw2" value="${member.mem_pw }" ></td>
                    </tr>
                    <tr>
                        <th>이름</th>
                    ...
                    <tr>
                        <th>주소</th>
                        <td>
                            <input type="text" name="post" id="post" value="${member.post }" placeholder="우편번호">
                            <a href="">주소검색</a>
                            <input type="text" name="addr1" value="${member.addr1 }" placeholder="기본 주소">
                            <input type="text" name="addr2" value="${member.addr2 }" placeholder="나머지 주소">
                        </td>
    ...
    function memberDelete() {
    	if(errorMessage) {
    		...
    		$("#updateFrm").attr("action", "memberDelete.do").attr("method", "post")	
    	}    	
    }
