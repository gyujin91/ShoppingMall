...
<a href="http://54.180.49.196:8080/myApp" target="_blank">http://daebu.o-r.kr:8080/myApp/</a>  (임시적으로 인스턴트 중지)
...
2) 각 관리 패널로 이동 가능
* ### 월별 판매량 및 매출표
1) 월 별 판매량 및 매출 그래프 시각화(Chart.js 활용)
* ### 총 주문 목록
