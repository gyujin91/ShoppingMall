...
<head>
    ...
    <style>
        ...
        .items .backImg
        {
            background: url(../resources/img/stars-2616537_1920.jpg);
            width: 100%;
            height: 500px;
            opacity: 0.8;
            position: relative;
    ...
    <div class="items">
        ...
        <div class="item">
            <div class="btnGroup">
                ...
                <button type="button" id="mantoman">맨투맨</button>
                <button type="button" id="hood">후드티</button>
                <button type="button" id="zipup">후드집업</button>
                <button type="button" id="outer">아우터</button>
                <button type="button" id="coat">코트</button>
                <button type="button" id="bottom">바지</button>
            </div>
            <c:choose>
